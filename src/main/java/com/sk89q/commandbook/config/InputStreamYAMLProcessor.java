 ...
 * @author sk89q
 */
public abstract class InputStreamYAMLProcessor extends YAMLNode {
    private final Yaml yaml;
    protected final File file;
    private String header = null;


    public InputStreamYAMLProcessor(File file, boolean writeDefaults, YAMLFormat format) {
    ...
    public InputStreamYAMLProcessor(File file, boolean writeDefaults) {
